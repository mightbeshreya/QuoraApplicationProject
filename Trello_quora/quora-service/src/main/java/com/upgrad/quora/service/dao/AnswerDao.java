...
public class AnswerDao {
    ...
    public List<AnswerEntity> getAllAnswers(String qusId) {
        return entityManager.createNamedQuery("getAllAnswers", AnswerEntity.class).setParameter("qusId", qusId).getResultList();
    }
